...
public class LoginTest extends BaseTest {
    ...
    @Test(testName = "UC-1 Test Login form with empty credentials")
    public void loginWithEmptyCredentials(){
        LoginPage loginPage = new LoginPage(driver);
        loginPage.enterUsername("sdsdsd");
        loginPage.enterPassword("kndskd");
    ...
    @Test(testName = "UC-2 Test Login form with credentials by passing Username")
    public void loginWithMissinPassword(){
        LoginPage loginPage = new LoginPage(driver);
        loginPage.enterUsername("ssdnds");
        loginPage.enterPassword("sdss");
        loginPage.clearPasswordField();
        loginPage.clickLoginButton();
        Assert.assertTrue(loginPage.getErrorMessage().contains("Username is required"),
    ...
    public void ValidateSucessfulLogin(HashMap<String,String> input){
        LoginPage loginPage = new LoginPage(driver);
